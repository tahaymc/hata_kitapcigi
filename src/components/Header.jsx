...
const Header = ({
    ...
    // Determine imports for prefetching (passed as props or defined here if they are simple functions)
    // For specific prefetching logic like onMouseEnter, we might need to pass the import functions as props or just keep it simple.
    // Let's assume onAddClick etc handles the prefetching or opening logic.
